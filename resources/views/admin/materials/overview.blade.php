...
@section('title', 'Kelola Materi Kursus - Admin')
@section('description', 'Kelola materi untuk semua kursus')
...
<div class="card card-flush">
	<div class="card-header pt-5">
		<h3 class="card-title align-items-start flex-column">
			<span class="card-label fw-bold text-gray-900">Daftar Kursus dengan Materi</span>
				...
				<tbody>
					@forelse($courses as $course)
						<tr>
							...
							<td>
								<span class="text-gray-900">{{ $course->owner->name ?? '-' }}</span>
							</td>
							<td>
							...
							<td>
								<a href="{{ route('admin.materials.index', $course->slug) }}" class="btn btn-sm btn-primary">
						...
						<tr>
							<td colspan="5" class="text-center text-muted py-10">
								<div class="d-flex flex-column align-items-center">
									...
									<a href="{{ route('admin.courses.create') }}" class="btn btn-sm btn-primary mt-3">Tambah Kursus</a>
								</div>
							</td>
						</tr>
					@endforelse
