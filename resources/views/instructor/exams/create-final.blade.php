...
@section('title', 'Tambah Soal Ujian - ' . $course->title)
            ...
            <div class="card">
                <div class="card-header border-0 pt-6">
                    <div class="card-title">
                        <h2>Tambah Soal Ujian - {{ $course->title }}</h2>
                    </div>
                ...
                <div class="card-body">
                    <form action="{{ route('instructor.exams.store-final', $course) }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="row mb-5">
                            <div class="col-md-6">
                                <label class="form-label">Upload File Soal (PDF/Word)</label>
                            ...
                            <div class="col-md-6">
                                <label class="form-label">Link Eksternal (Google Drive/YouTube)</label>
                        ...
                        <div class="row mb-5">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="form-check form-switch mt-3">
                                    ...
                                    <label class="form-check-label" for="is_active">Aktifkan ujian ini</label>
                                </div>
                                <div class="form-text">Jika diaktifkan, ujian sebelumnya akan dinonaktifkan</div>
                            </div>
                        </div>
