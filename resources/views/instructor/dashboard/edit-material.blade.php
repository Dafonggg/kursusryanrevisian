...
<div id="kt_app_toolbar" class="app-toolbar py-3 py-lg-6">
	<div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
		...
		<div class="d-flex align-items-center gap-2 gap-lg-3">
			<a href="{{ route('instructor.materials.index', $course->slug) }}" class="btn btn-sm fw-bold btn-secondary">Kembali</a>
		</div>
	</div>
</div>
@endsection
	...
	<div class="card-body pt-0">
		<form action="{{ route('instructor.materials.update', [$course->slug, $material->id]) }}" method="POST" enctype="multipart/form-data">
			...
			<div class="mb-10">
				...
				<div class="form-text">Format: PDF, DOC, DOCX, PPT, PPTX, ZIP, RAR (Maks: 10MB). Bisa dikombinasikan dengan URL. Kosongkan jika tidak ingin mengubah file.</div>
				@error('path')
					<div class="invalid-feedback">{{ $message }}</div>
				@enderror
			</div>
			...
			<div class="d-flex justify-content-end gap-2">
				<a href="{{ route('instructor.materials.index', $course->slug) }}" class="btn btn-light">Batal</a>
