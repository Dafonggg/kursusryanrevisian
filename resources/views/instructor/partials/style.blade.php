<!--begin::Head-->
<base href="{{ asset('/') }}" />
<title>@yield('title', 'Instructor Dashboard - Metronic')</title>
<meta charset="utf-8" />
<meta name="description" content="@yield('description', 'Instructor Dashboard for Multi-Role System')" />
...
<!--end::Shared Styles-->
<!--begin::Page Styles-->
<link href="{{ asset('metronic_html_v8.2.9_demo1/demo1/src/partialsInstructor/_styles.css') }}" rel="stylesheet" type="text/css" />
<!--end::Page Styles-->
@stack('styles')
<!--end::Head-->
